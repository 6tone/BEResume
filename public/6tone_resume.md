...
**Backend Lead / Technical Project Manager**
Kaohsiung, Taiwan | contact.6tone@gmail.com | [github.com/6tone](https://github.com/6tone)
...
Jan 2020 - Feb 2024
*Node.js (Express) / C++ / Redis / MySQL / MSSQL / MongoDB / React / GitLab CI/CD*
...
*(相關專案：盛欣官網、鬥陣江湖、鬥陣歡樂城)*

---

## Automation Tools & Side Projects

**多平台帳務爬蟲與記帳系統**
* 使用 Node.js 爬蟲與 Cron Job 定期抓取交易日誌，經資料清洗後匯入 MongoDB 進行自動化彙整，降低人工對帳成本。

**多策略自動化交易引擎**
* 解析 WebSocket 協定進行即時數據串流擷取，實作勝率評估演算法並自動觸發交易；採用 Promise Pool 管理多帳號非同步任務，並使用 pkg 打包為跨平台獨立執行檔。

---

## Skills

**Programming Languages**: JavaScript (ES6+), C++ (11/14), SQL
**Frameworks & Engines**: Node.js, Pomelo.js, Express.js, React
**Databases & Cache**: MongoDB, MySQL, MSSQL, Redis
**DevOps & Cloud**: AWS (EC2, S3, CloudFront), Docker, PM2, GitLab CI/CD, Jenkins, Git Flow
**Security & Integrations**: OAuth 2.0 / OIDC, IAP In-App Purchase, Webhook Idempotency
**Engineering Methodology**: OOP Domain Modeling, Separation of Concerns, RESTful API Design, Agile / Scrum
